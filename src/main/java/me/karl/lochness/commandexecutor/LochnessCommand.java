        ...
        switch (args[0]) {
            ...
            case "item":
                switch (args[1]) {
                    ...
                    case "striderFood":
                        ItemStack striderFood = new ItemStack(Material.STRUCTURE_BLOCK);
                        meta = striderFood.getItemMeta();
                        meta.setDisplayName("Striderfood");
                        meta.setCustomModelData(1);
                        striderFood.setItemMeta(meta);
                        p.getInventory().addItem(striderFood);
                        break;

                    case "goldenCod":
                        ItemStack cod = new ItemStack(Material.STRUCTURE_BLOCK);
                        meta = cod.getItemMeta();
                        meta.setDisplayName("Golden Cod");
            ...
            case "entity":
                switch (args[1]) {
                    ...
                    case "resetDefault":
                        CaveLogic.isResetingCave = true;
                        LochnessEntity.deleteEntityFiles();
                        CaveLogic.clearEntities();
                        LochnessEntity.verifyEntities();
                        if (PortalOpenEvent.isPortalOpen)
                            CaveLogic.spawnUnbeatenEntities();
                ...
                switch (args[1]) {
                    ...
                    case "verify":
                        ...
                        if (isInstalled)
                            ...
                            sender.sendMessage("Try to install it manually and ensure, it is a valid uncorrupted zip file");
                        }
                        break;
                    default: sender.sendMessage(Lochness.getPrefix() + ChatColor.RED + "invalid arguments");
                }
